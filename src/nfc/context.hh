...
namespace nfc {
  ...
  protected:
    struct GetDevicesData;
    static void RunGetDevices(Context &instance, GetDevicesData &data);
    static v8::Handle<v8::Value> AfterGetDevices(v8::Handle<v8::Object> instance, GetDevicesData &data);
